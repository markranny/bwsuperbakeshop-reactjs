      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-bold text-navy-800 mb-4">Delivery Information</h2>
            <div className="w-24 h-1 bg-blue-500 mx-auto mb-4"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We deliver our freshly baked goods right to your doorstep
            </p>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-navy-800 mb-2">Delivery Areas</h3>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-2"></i>
                    <span>Tarlac City - Free Delivery</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-2"></i>
                    <span>Concepcion - ₱50 Delivery Fee</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-2"></i>
                    <span>Capas - ₱50 Delivery Fee</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-2"></i>
                    <span>La Paz - ₱75 Delivery Fee</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-2"></i>
                    <span>Other areas - Please call for availability</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-navy-800 mb-2">Delivery Information</h3>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                    <span>Minimum order of ₱300 for delivery</span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                    <span>Place your order at least 2 hours in advance</span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                    <span>Delivery hours: 8:00 AM - 6:00 PM daily</span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                    <span>For special orders and cakes, please order 2 days ahead</span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                    <span>Payment methods: Cash on delivery, GCash, or bank transfer</span>
                  </li>
                </ul>
              </motion.div>
            </div>
