...
const Products = () => {
  ...
  return (
    <div className="pt-16 pb-24"> {/* Add padding for the fixed header and nav */}
      ...
      {/* Baking Process Section - New Addition */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-navy-800 mb-4">Made Fresh Daily</h2>
              <div className="w-24 h-1 bg-blue-500 mb-6"></div>
              <p className="text-gray-600 mb-4">
                Every product in our bakery is made fresh daily, using traditional methods and the finest ingredients.
              </p>
              <p className="text-gray-600 mb-6">
                We start baking at 4 AM every day to ensure that our customers receive only the freshest baked goods.
                No preservatives, no shortcuts - just pure baking craftsmanship.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center">
                  ...
                  <span className="text-gray-600">Premium locally-sourced ingredients</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">Traditional baking methods</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">No preservatives or artificial additives</span>
                </li>
              </ul>
              <motion.button
                className="bg-navy-800 text-white px-6 py-3 rounded-full text-sm font-medium"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
            ...
            >
              <img 
                src="/images/products/baking-process.jpg" 
